...
gen-api:
	...
	oapi-codegen -generate client,types -package vdr -import-mapping='../common/ssi_types.yaml:github.com/nuts-foundation/nuts-admin/nuts' -o identity/vdr/client.gen.go https://nuts-node.readthedocs.io/en/latest/_static/vdr/v2.yaml
	oapi-codegen -generate client,types -package vcr -import-mapping='../common/ssi_types.yaml:github.com/nuts-foundation/nuts-admin/nuts' -o identity/vcr/client.gen.go https://nuts-node.readthedocs.io/en/latest/_static/vcr/vcr_v2.yaml
